...
int Bot_V2::piecePunctuation(int type) {
	switch (type)
	{
	case PAWN:
...
int Bot_V2::EvaluateGame(bool turn) {
    int score = 0;
...
int Bot_V2::materialEvaluation(bool turn) {
	int score = 0;
...
int Bot_V2::defenseEvaluation(bool turn) {
	int score = 0;
...
//----------------------------------------------------------------
int Bot_V2::centerControlEvaluation(bool color) {
...
//----------------------------------------------------------------
int Bot_V2::mobilityEvaluation(bool color) {
	int mobility = 0;
...
//----------------------------------------------------------------
int Bot_V2::kingSafetyEvaluation(bool color) {
...
//----------------------------------------------------------------
int Bot_V2::pawnStructureEvaluation(bool color) {
...
//----------------------------------------------------------------
int Bot_V2::pieceCoordinationEvaluation(bool color) {
	int coordination = 0;
...
vector<Move> Bot_V2::generateAllMoves(bool color) {
...
vector<Move> Bot_V2::generateCaptureMoves(bool color) {
	vector<Move> legalMoves;
...
void Bot_V2::orderMoves(vector<Move>& moves) {
...
Bot_V2::search_result Bot_V2::SearchMoves(int depth, int alpha, int beta, bool maximizingPlayer) {
...
Bot_V2::search_result Bot_V2::SearchCaptures(int depth, int alpha, int beta, bool maximizingPlayer) {
	int bestEval = (maximizingPlayer) ? INIT_MAX : INIT_MIN;
	bool color = (maximizingPlayer) ? WHITE : BLACK;
	vector<Move> moves;
	if (depth == 0) {
...
void Bot_V2::sortMovesByEvaluation(vector<Move>& moves,bool color) {
